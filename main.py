...
class User(UserMixin, db.Model):
    ...
    #Create a blog post object attached to the user. AUthor refers to to author in blogpost
    posts = db.relationship("BlogPost", back_populates='author')
    # Create a comments object attached to the user. comment_author refers to comment_author in comments
